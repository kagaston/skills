...
description: Guides creation of distinctive, production-grade frontend interfaces with bold aesthetic direction. Use when building components, pages, or applications that need to avoid generic AI aesthetics.
